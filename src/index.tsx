...
app.get('/', (c) => {
  return c.html(`
    ...
    <head>
        ...
        <title>IsoGuard Audit - Asistente Inteligente ISO 27001:2022</title>
        <meta name="description" content="IsoGuard Audit - Asistente inteligente para auditorías internas ISO 27001:2022">
        ...
        <div class="sidebar">
            <div class="p-6">
                <div class="flex items-center mb-8">
                    ...
                    <div>
                        <h1 class="text-xl font-bold">IsoGuard Audit</h1>
